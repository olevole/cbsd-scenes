...
INSERT INTO forms ( param,desc,defaults,mandatory,attr ) VALUES ( "redminepw","Please enter MySQL Redmine user password",'',1, "maxlen=20" );
INSERT INTO forms ( param,desc,defaults,mandatory,attr ) VALUES ( "fqdn","Please enter vhost FQDN",'',1, "maxlen=30" );
INSERT INTO forms ( param,desc,defaults,mandatory,attr ) VALUES ( "redminelang","Please enter Redmine Lang (en,ru,fr,de,...):",'en',1, "maxlen=30" );
COMMIT;
EOF
