...
$CONF['setup_password'] = '%%SETUPPW%%';

// Postfix Admin Path
// Set the location of your Postfix Admin installation here.
// YOU MUST ENTER THE COMPLETE URL e.g. http://domain.tld/postfixadmin
$CONF['postfix_admin_url'] = 'http://%%FQDN%%';
...
$CONF['database_password'] = '%%POSTFIXPW%%';
...
$CONF['admin_email'] = 'postmaster@%%FQDN%%';
...
$CONF['vacation_domain'] = 'autoreply.%%FQDN%%';
...
$CONF['user_footer_link'] = "http://%%FQDN%%/main";

// Footer
// Below information will be on all pages.
// If you don't want the footer information to appear set this to 'NO'.
$CONF['show_footer_text'] = 'NO';
$CONF['footer_text'] = 'Return to %%FQDN%%';
$CONF['footer_link'] = 'http://%%FQDN%%';
